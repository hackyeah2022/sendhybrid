...
const isAddressNotEmpty = (reportDetails, prefix) => Object.entries(reportDetails)
...
const Address = ({reportDetails, prefix}) => {
    ...
    const getProperty = (keyWithoutPrefix: string) => reportDetails[`${prefix}${keyWithoutPrefix}`]
    return (
        <address>
