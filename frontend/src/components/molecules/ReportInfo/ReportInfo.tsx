    ...
    return (
        <>
           ...
           <BadgesRow>
            ...
            <FixedMessage>
                {
                    !reportDetails.validationPdfFailed && reportDetails.validationFilenameFailed && (
                        <span>
                ...
                {
                    reportDetails.validationPdfFailed && reportDetails.correctedPreviewUrl && (
                        <span>
                            Skonwertowano plik Worda do PDF. Pobierz go, podpisz i prześlij ponownie.
                        </span>
                    )
                }
            </FixedMessage>
