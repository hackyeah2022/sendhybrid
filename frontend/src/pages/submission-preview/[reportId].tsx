...
import useSingleReport, {getSingleReportQueryKey} from "../../hooks/useSingleReport";
...
const SubmissionPreviewPage: FC<ReportPageProps> = () => {
    ...
    const {
        mutateAsync,
        isSuccess: hasSentSuccessfully
    } = useMutation(['markAsSent'], () => markAsSend(reportDetails.id))
